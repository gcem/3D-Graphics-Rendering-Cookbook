...
struct MyApp : public CameraApp
{
    MyApp()
      ...
      , ssao(ctx_,
             finalRenderer.outputColor /*colorTex for no-HDR */,
             depthTex,
             finalTex)
    ...
    void drawUI() override
    {
        ...
        ImGui::Checkbox("Render transparent objects",
                        &finalRenderer.renderTransparentObjects);
        ...
        if (showHDRDebug) {
            ...
            ImGui::Text("Adapt1");
            ImGui::Image((void *)(intptr_t)(19 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Adapt2");
            ImGui::Image((void *)(intptr_t)(20 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::End();
            ...
            ImGui::Image((void *)(intptr_t)(15 | TEX_RGB),
                         ...
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Result");
            ImGui::Image((void *)(intptr_t)(16 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
    ...
    void draw3D() override
    {
        ...
        if (finalRenderer.enableShadows && showLightFrustum) {
            drawBox3d(canvas,
                      glm::scale(glm::mat4(1.f), vec3(1, -1, 1)),
                      bigBox,
                      glm::vec4(0, 0, 0, 1));
