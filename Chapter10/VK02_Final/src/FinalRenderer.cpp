...
void
BaseMultiRenderer::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                     size_t currentImage,
                                     VkFramebuffer fb,
                                     VkRenderPass rp)
{
...
void
BaseMultiRenderer::updateIndirectBuffers(size_t currentImage, bool *visibility)
{
...
bool
FinalMultiRenderer::checkLoadedTextures()
{
