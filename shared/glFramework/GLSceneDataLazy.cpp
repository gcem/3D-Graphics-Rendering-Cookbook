...
GLSceneDataLazy::GLSceneDataLazy(const char *meshFile,
...
bool
GLSceneDataLazy::uploadLoadedTextures()
{
...
void
GLSceneDataLazy::updateMaterials()
{
...
void
GLSceneDataLazy::loadScene(const char *sceneFile)
{
