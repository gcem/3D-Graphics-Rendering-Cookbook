...
/* To avoid breaking chapter 1-6 samples, we introduce a class which differs
 * from VulkanInstance in that it has a ctor & dtor */
...
bool
createOffscreenImageFromData(VulkanRenderDevice &vkDev,
                             VkImage &textureImage,
                             VkDeviceMemory &textureImageMemory,
                             void *imageData,
                             uint32_t texWidth,
...
// Utility structure for Renderer classes to know the details about starting
// this pass
struct RenderPass
{
    RenderPass() = default;
...
bool
createColorOnlyRenderPass(VulkanRenderDevice &device,
                          VkRenderPass *renderPass,
                          const RenderPassCreateInfo &ci,
                          VkFormat colorFormat = VK_FORMAT_B8G8R8A8_UNORM);
bool
createColorAndDepthRenderPass(VulkanRenderDevice &device,
                              bool useDepth,
                              VkRenderPass *renderPass,
                              const RenderPassCreateInfo &ci,
                              VkFormat colorFormat = VK_FORMAT_B8G8R8A8_UNORM);
...
/* VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL for real update of an existing
 * texture */
bool
...
inline uint32_t
getVulkanBufferAlignment(VulkanRenderDevice &vkDev)
{
...
inline bool
setVkImageName(VulkanRenderDevice &vkDev, void *object, const char *name)
{
