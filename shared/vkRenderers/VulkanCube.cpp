...
bool
CubeRenderer::createDescriptorSet(VulkanRenderDevice &vkDev)
{
...
void
CubeRenderer::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                size_t currentImage)
{
    EASY_FUNCTION();
...
void
CubeRenderer::updateUniformBuffer(VulkanRenderDevice &vkDev,
...
CubeRenderer::CubeRenderer(VulkanRenderDevice &vkDev,
