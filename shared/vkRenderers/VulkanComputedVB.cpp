...
bool
ComputedVertexBuffer::createComputedSetLayout()
{
...
bool
ComputedVertexBuffer::createDescriptorSet()
{
    ...
    const VkDescriptorBufferInfo bufferInfo2 = { uniformBuffer.buffer,
                                                 0,
                                                 uniformBuffer.size };
...
void
ComputedVertexBuffer::downloadVertices(void *vertexData)
{
...
void
ComputedVertexBuffer::uploadIndexData(uint32_t *indices)
{
    uploadBufferData(vkDev,
                     computedMemory,
                     computedVertexCount * vertexSize,
                     indices,
                     indexBufferSize);
}
