...
ComputedImage::ComputedImage(VulkanRenderDevice &vkDev,
...
bool
ComputedImage::createComputedTexture(uint32_t computedWidth,
                                     uint32_t computedHeight,
                                     VkFormat format)
{
...
bool
ComputedImage::createComputedImageSetLayout()
{
...
bool
ComputedImage::createDescriptorSet()
{
...
void
ComputedImage::downloadImage(void *imageData)
{
    if (!canDownloadImage || !imageData)
        return;

    downloadImageData(vkDev,
                      computed.image,
                      computedWidth,
                      computedHeight,
