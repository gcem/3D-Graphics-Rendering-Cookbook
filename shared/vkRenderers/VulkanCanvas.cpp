...
void
VulkanCanvas::updateBuffer(VulkanRenderDevice &vkDev, size_t currentImage)
{
    if (lines_.empty())
        return;
...
bool
VulkanCanvas::createDescriptorSet(VulkanRenderDevice &vkDev)
{
...
void
VulkanCanvas::updateUniformBuffer(VulkanRenderDevice &vkDev,
...
void
VulkanCanvas::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                size_t currentImage)
{
    EASY_FUNCTION();
...
void
VulkanCanvas::line(const vec3 &p1, const vec3 &p2, const vec4 &c)
{
...
void
VulkanCanvas::plane3d(const vec3 &o,
                      const vec3 &v1,
                      const vec3 &v2,
                      int n1,
                      int n2,
