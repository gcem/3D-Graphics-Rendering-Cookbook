...
ComputedItem::ComputedItem(VulkanRenderDevice &vkDev,
...
void
ComputedItem::fillComputeCommandBuffer(void *pushConstant,
...
ComputedItem::submit()
{
    ...
    return (vkQueueSubmit(vkDev.computeQueue, 1, &submitInfo, fence) ==
            VK_SUCCESS);
}

void
ComputedItem::waitFence()
{
