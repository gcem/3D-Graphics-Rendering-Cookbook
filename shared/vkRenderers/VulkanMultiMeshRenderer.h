...
public:
    ...
    void updateIndirectBuffers(VulkanRenderDevice &vkDev,
                               size_t currentImage,
    ...
    void updateGeometryBuffers(VulkanRenderDevice &vkDev,
                               ...
                               const void *vertices,
                               const void *indices);
    void updateMaterialBuffer(VulkanRenderDevice &vkDev,
    ...
    void updateDrawDataBuffer(VulkanRenderDevice &vkDev,
                              ...
                              const void *drawData);
    void updateCountBuffer(VulkanRenderDevice &vkDev,
                           size_t currentImage,
                           uint32_t itemCount);
...
private:
    ...
    /* DrawData loaded from file. Converted to indirectBuffers[] and uploaded to
     * drawDataBuffers[] */
