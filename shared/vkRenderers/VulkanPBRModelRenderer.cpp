...
bool
PBRModelRenderer::createDescriptorSet(VulkanRenderDevice &vkDev,
                                      uint32_t uniformDataSize)
{
    const std::vector<VkDescriptorSetLayoutBinding> bindings = {
        ...
        descriptorSetLayoutBinding(5,
                                   VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                   VK_SHADER_STAGE_FRAGMENT_BIT), // Albedo
        descriptorSetLayoutBinding(6,
                                   VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                   VK_SHADER_STAGE_FRAGMENT_BIT), // MeR
        descriptorSetLayoutBinding(7,
                                   VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                   VK_SHADER_STAGE_FRAGMENT_BIT), // Normal

        descriptorSetLayoutBinding(8,
                                   VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                   VK_SHADER_STAGE_FRAGMENT_BIT), // env
        descriptorSetLayoutBinding(9,
                                   VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                                   VK_SHADER_STAGE_FRAGMENT_BIT), // env_IRR

        descriptorSetLayoutBinding(10,
                                   VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
...
void
PBRModelRenderer::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                    size_t currentImage)
{
    beginRenderPass(commandBuffer, currentImage);

    vkCmdDraw(commandBuffer,
              static_cast<uint32_t>(indexBufferSize_ / (sizeof(unsigned int))),
              1,
              0,
              0);
...
void
PBRModelRenderer::updateUniformBuffer(VulkanRenderDevice &vkDev,
...
static void
loadTexture(VulkanRenderDevice &vkDev,
            const char *fileName,
...
static void
loadCubeMap(VulkanRenderDevice &vkDev,
            const char *fileName,
  ...
  : RendererBase(vkDev, VulkanImage())
{
    ...
    if (!createPBRVertexBuffer(vkDev,
                               modelFile,
                               &storageBuffer_,
