...
bool
VulkanSingleQuadRenderer::createDescriptorSet(VulkanRenderDevice &vkDev,
...
void
VulkanSingleQuadRenderer::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                            size_t currentImage)
{
...
VulkanSingleQuadRenderer::VulkanSingleQuadRenderer(VulkanRenderDevice &vkDev,
                                                   VulkanImage tex,
                                                   VkSampler sampler,
                                                   VkImageLayout desiredLayout)
  : vkDev(vkDev)
  ...
  , RendererBase(vkDev, VulkanImage())
{
    ...
    if (!createUniformBuffers(vkDev, sizeof(uint32_t)) ||
        ...
        !createGraphicsPipeline(vkDev,
                                renderPass_,
                                pipelineLayout_,
                                { "data/shaders/chapter06/VK03_quad.vert",
                                  "data/shaders/chapter06/VK03_quad.frag" },
                                &graphicsPipeline_)) {
