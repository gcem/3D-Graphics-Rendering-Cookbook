...
{
    HDRProcessor(VulkanRenderContext &c,
                 VulkanTexture input,
                 VulkanTexture avgLuminance,
                 BufferAttachment uniformBuffer)
      : CompositeRenderer(c)
      ,
      ...
      , resultToShader(c, resultTex)
    {
        ...
        updateTextureImage(c.vkDev,
                           adaptedLuminanceTex1.image.image,
                           adaptedLuminanceTex1.image.imageMemory,
                           1,
                           1,
                           LuminosityFormat,
                           1,
        ...
        updateTextureImage(c.vkDev,
                           adaptedLuminanceTex2.image.image,
                           adaptedLuminanceTex2.image.imageMemory,
                           1,
                           1,
                           LuminosityFormat,
                           1,
    ...
    void fillCommandBuffer(VkCommandBuffer cmdBuffer,
                           size_t currentImage,
                           VkFramebuffer fb1 = VK_NULL_HANDLE,
                           VkRenderPass rp1 = VK_NULL_HANDLE) override
    {
        // Call base method
        CompositeRenderer::fillCommandBuffer(cmdBuffer, currentImage, fb1, rp1);
        // Swap avgLuminance inputs for adaptation and composer
        static const std::vector<int> switchIndices{ 21, 22, 23, 24,
                                                     25, 26, 28, 29 };
    ...
    inline VulkanTexture getAdaptatedLum1() const
    {
        return adaptedLuminanceTex1;
    }
    inline VulkanTexture getAdaptatedLum2() const
    {
        return adaptedLuminanceTex2;
    }
