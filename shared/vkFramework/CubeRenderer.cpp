...
void
CubemapRenderer::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                   size_t currentImage,
                                   VkFramebuffer fb,
                                   VkRenderPass rp)
{
  ...
  : Renderer(ctx)
{
    ...
    initPipeline({ "data/shaders/chapter08/VK03_CubeMap.vert",
                   "data/shaders/chapter08/VK03_CubeMap.frag" },
                 pInfo);
}

void
CubemapRenderer::updateBuffers(size_t currentImage)
{
