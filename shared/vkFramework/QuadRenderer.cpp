...
void
QuadRenderer::quad(float x1, float y1, float x2, float y2, int texIdx)
{
...
void
QuadRenderer::fillCommandBuffer(VkCommandBuffer commandBuffer,
                                size_t currentImage,
                                VkFramebuffer fb,
                                VkRenderPass rp)
{
...
void
QuadRenderer::updateBuffers(size_t currentImage)
{
    if (!quads_.empty())
  ...
  : Renderer(ctx)
{
    ...
    initPipeline({ "data/shaders/chapter08/VK02_QuadRenderer.vert",
                   "data/shaders/chapter08/VK02_QuadRenderer.frag" },
                 pInfo);
}
