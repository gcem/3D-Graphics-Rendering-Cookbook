...
static int
glad_vk_get_extensions(VkPhysicalDevice physical_device,
                       ...
                       char ***out_extensions)
{
    ...
    if (physical_device != NULL) {
        ...
        for (i = 0; i < device_extension_count; ++i) {
            ...
            memcpy(extensions[instance_extension_count + i],
                   ext.extensionName,
                   extension_name_length * sizeof(char));
        }
    }
...
static int
glad_vk_has_extension(const char *name,
...
static int
glad_vk_find_extensions_vulkan(VkPhysicalDevice physical_device)
{
...
static int
glad_vk_find_core_vulkan(VkPhysicalDevice physical_device)
{
    int major = 1;
    int minor = 0;
...
int
gladLoadVulkanUserPtr(VkPhysicalDevice physical_device,
...
{
    return gladLoadVulkanUserPtr(physical_device,
