...
static void
glad_gl_load_GL_VERSION_4_0(GLADuserptrloadfunc load, void *userptr)
{
...
static void
glad_gl_load_GL_VERSION_4_1(GLADuserptrloadfunc load, void *userptr)
{
...
static void
glad_gl_load_GL_VERSION_4_2(GLADuserptrloadfunc load, void *userptr)
{
...
static void
glad_gl_load_GL_VERSION_4_3(GLADuserptrloadfunc load, void *userptr)
{
...
static void
glad_gl_load_GL_VERSION_4_4(GLADuserptrloadfunc load, void *userptr)
{
...
static void
glad_gl_load_GL_VERSION_4_5(GLADuserptrloadfunc load, void *userptr)
{
    ...
    glad_glGetTextureLevelParameterfv =
      (PFNGLGETTEXTURELEVELPARAMETERFVPROC)load(userptr,
                                                "glGetTextureLevelParameterfv");
    glad_glGetTextureLevelParameteriv =
      (PFNGLGETTEXTURELEVELPARAMETERIVPROC)load(userptr,
    ...
    glad_glNamedFramebufferDrawBuffer =
      (PFNGLNAMEDFRAMEBUFFERDRAWBUFFERPROC)load(userptr,
    ...
    glad_glNamedFramebufferParameteri =
      (PFNGLNAMEDFRAMEBUFFERPARAMETERIPROC)load(userptr,
                                                "glNamedFramebufferParameteri");
    glad_glNamedFramebufferReadBuffer =
      (PFNGLNAMEDFRAMEBUFFERREADBUFFERPROC)load(userptr,
...
static void
glad_gl_load_GL_VERSION_4_6(GLADuserptrloadfunc load, void *userptr)
{
...
static void
glad_gl_load_GL_ARB_bindless_texture(GLADuserptrloadfunc load, void *userptr)
{
    ...
    glad_glGetTextureSamplerHandleARB =
      (PFNGLGETTEXTURESAMPLERHANDLEARBPROC)load(userptr,
    ...
    glad_glIsTextureHandleResidentARB =
      (PFNGLISTEXTUREHANDLERESIDENTARBPROC)load(userptr,
    ...
    glad_glMakeImageHandleResidentARB =
      (PFNGLMAKEIMAGEHANDLERESIDENTARBPROC)load(userptr,
    ...
    glad_glUniformHandleui64vARB =
      (PFNGLUNIFORMHANDLEUI64VARBPROC)load(userptr, "glUniformHandleui64vARB");
    glad_glVertexAttribL1ui64ARB =
      (PFNGLVERTEXATTRIBL1UI64ARBPROC)load(userptr, "glVertexAttribL1ui64ARB");
...
static int
glad_gl_get_extensions(int version,
                       const char **out_exts,
...
static void
glad_gl_free_extensions(char **exts_i, unsigned int num_exts_i)
{
    if (exts_i != NULL) {
        unsigned int index;
        for (index = 0; index < num_exts_i; index++) {
...
static int
glad_gl_has_extension(int version,
                      const char *exts,
...
static GLADapiproc
glad_gl_get_proc_from_userptr(void *userptr, const char *name)
{
...
static int
glad_gl_find_extensions_gl(int version)
{
