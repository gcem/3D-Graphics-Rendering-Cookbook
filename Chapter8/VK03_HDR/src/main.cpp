...
struct MyApp : public CameraApp
{
    MyApp()
      ...
      ,
      // Temporarily we switch between luminances [coming from PingPong light
      ...
      displayedTextureList({ hdrTex,
                             HDRLuminance,
                             luminance.getResult64(),
                             luminance.getResult32(),
                             luminance.getResult16(),
                             luminance.getResult08(),
                             luminance.getResult04(),
                             luminance.getResult02(),
                             luminance.getResult01(), // 2 - 9
                             hdr.getBloom1(),
                             hdr.getBloom2(),
                             hdr.getBrightness(),
                             hdr.getResult(), // 10 - 13
                             HDRLuminance,
                             hdr.getStreaks1(),
                             hdr.getStreaks2(), // 14 - 16
                             hdr.getAdaptatedLum1(),
                             hdr.getAdaptatedLum2() })
      , // 17 - 18
    ...
    {
        positioner = CameraPositioner_FirstPerson(vec3(-15.81f, -5.18f, -5.81f),
                                                  vec3(0.0f, 0.0f, -1.0f),
                                                  vec3(0.0f, 1.0f, 0.0f));
    ...
    void drawUI() override
    {
        ...
        if (showPyramid) {
            ...
            ImGui::Text("HDRColor");
            ImGui::Image((void *)(intptr_t)(2 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum64");
            ImGui::Image((void *)(intptr_t)(3 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum32");
            ImGui::Image((void *)(intptr_t)(4 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum16");
            ImGui::Image((void *)(intptr_t)(5 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum08");
            ImGui::Image((void *)(intptr_t)(6 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum04");
            ImGui::Image((void *)(intptr_t)(7 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum02");
            ImGui::Image((void *)(intptr_t)(8 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Lum01");
            ImGui::Image((void *)(intptr_t)(9 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::End();
        ...
        if (showDebug) {
            ...
            ImGui::Text("Adapt1");
            ImGui::Image((void *)(intptr_t)(17 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Adapt2");
            ImGui::Image((void *)(intptr_t)(18 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::End();
            ...
            ImGui::Text("Bloom1");
            ImGui::Image((void *)(intptr_t)(10 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Bloom2");
            ImGui::Image((void *)(intptr_t)(11 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Bright");
            ImGui::Image((void *)(intptr_t)(12 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Result");
            ImGui::Image((void *)(intptr_t)(13 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));

            ImGui::Text("Streaks1");
            ImGui::Image((void *)(intptr_t)(14 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::Text("Streaks2");
            ImGui::Image((void *)(intptr_t)(15 | TEX_RGB),
                         ImVec2(128, 128),
                         ImVec2(0.0f, 1.0f),
                         ImVec2(1.0f, 0.0f));
            ImGui::End();
