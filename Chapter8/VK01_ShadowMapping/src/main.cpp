...
struct MyApp : public CameraApp
{
    MyApp()
      ...
      meshBuffer(ctx_.resources.loadMeshToBuffer(g_meshFile,
                                                 true,
                                                 true,
                                                 meshVertices,
                                                 meshIndices))
      ...
      depthRenderer(ctx_,
                    ...
                    { "data/shaders/chapter08/VK01_shadow.vert",
                      "data/shaders/chapter08/VK01_shadow.frag" },
                    true)
      ,
      ...
      , imgui(ctx_, { meshShadowColor, meshShadowDepth })
    {
        ...
        positioner.lookAt(glm::vec3(-85.0f, 85.0f, 85.0f),
                          vec3(0.0f, 0.0f, 0.0f),
                          vec3(0.0f, 1.0f, 0.0f));
