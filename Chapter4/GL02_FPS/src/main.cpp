...
CameraPositioner_FirstPerson positioner(vec3(0.0f),
                                        vec3(0.0f, 0.0f, -1.0f),
                                        vec3(0.0f, 1.0f, 0.0f));
...
main(void)
{
    ...
    GLShader shdModelVertex("data/shaders/chapter04/GL01_duck.vert");
    GLShader shdModelFragment("data/shaders/chapter04/GL01_duck.frag");
    GLProgram progModel(shdModelVertex, shdModelFragment);

    GLShader shdCubeVertex("data/shaders/chapter04/GL01_cube.vert");
    GLShader shdCubeFragment("data/shaders/chapter04/GL01_cube.frag");
    ...
    GLuint cubemapTex;
    {
        ...
        for (unsigned i = 0; i != 6; ++i) {
            glTextureSubImage3D(cubemapTex,
                                0,
                                0,
                                0,
                                i,
