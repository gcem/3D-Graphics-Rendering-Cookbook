...
extern std::string
Enum2String(GLenum e);

void
GLTracer_glCullFace(GLenum mode)
{
    printf("glCullFace("
           "%s)\n",
           E2S(mode));
...
void
GLTracer_glPolygonMode(GLenum face, GLenum mode)
{
...
void
GLTracer_glScissor(GLint x, GLint y, GLsizei width, GLsizei height)
{
    printf("glScissor("
           "%i, %i, %i, %i)\n",
           x,
...
void
GLTracer_glTexParameterf(GLenum target, GLenum pname, GLfloat param)
{
...
void
GLTracer_glTexParameterfv(GLenum target, GLenum pname, const GLfloat *params)
{
...
void
GLTracer_glTexParameteri(GLenum target, GLenum pname, GLint param)
{
...
void
GLTracer_glTexParameteriv(GLenum target, GLenum pname, const GLint *params)
{
...
void
GLTracer_glTexImage2D(GLenum target,
                      GLint level,
...
void
GLTracer_glClear(GLbitfield mask)
{
    printf("glClear("
           "%u)\n",
           (unsigned int)(mask));
...
void
GLTracer_glClearColor(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
    printf("glClearColor("
           "%f, %f, %f, %f)\n",
           red,
...
void
GLTracer_glClearStencil(GLint s)
{
...
void
GLTracer_glClearDepth(GLdouble depth)
{
    printf("glClearDepth("
           "%f)\n",
           depth);
...
void
GLTracer_glColorMask(GLboolean red,
                     GLboolean green,
                     GLboolean blue,
                     GLboolean alpha)
{
...
void
GLTracer_glDepthMask(GLboolean flag)
{
    printf("glDepthMask("
           "%u)\n",
           (unsigned int)(flag));
...
void
GLTracer_glBlendFunc(GLenum sfactor, GLenum dfactor)
{
    printf("glBlendFunc("
           "%s, %s)\n",
           E2S(sfactor),
...
void
GLTracer_glDepthFunc(GLenum func)
{
    printf("glDepthFunc("
           "%s)\n",
           E2S(func));
...
void
GLTracer_glPixelStorei(GLenum pname, GLint param)
{
...
void
GLTracer_glReadBuffer(GLenum src)
{
    printf("glReadBuffer("
           "%s)\n",
           E2S(src));
...
void
GLTracer_glGetIntegerv(GLenum pname, GLint *data)
{
...
const GLubyte *
GLTracer_glGetString(GLenum name)
{
    printf("glGetString("
           "%s)\n",
           E2S(name));
...
void
GLTracer_glGetTexImage(GLenum target,
                       GLint level,
                       GLenum format,
                       GLenum type,
                       void *pixels)
...
void
GLTracer_glGetTexLevelParameteriv(GLenum target,
                                  GLint level,
                                  GLenum pname,
                                  GLint *params)
{
...
void
GLTracer_glViewport(GLint x, GLint y, GLsizei width, GLsizei height)
{
    printf("glViewport("
           "%i, %i, %i, %i)\n",
           x,
...
void
GLTracer_glDrawArrays(GLenum mode, GLint first, GLsizei count)
{
    printf("glDrawArrays("
           "%s, %i, %i)\n",
           E2S(mode),
...
void
GLTracer_glDrawElements(GLenum mode,
                        GLsizei count,
                        GLenum type,
                        const void *indices)
{
...
void
GLTracer_glTexSubImage2D(GLenum target,
                         GLint level,
                         GLint xoffset,
                         GLint yoffset,
                         GLsizei width,
...
void
GLTracer_glDeleteTextures(GLsizei n, const GLuint *textures)
{
...
void
GLTracer_glGenTextures(GLsizei n, GLuint *textures)
{
...
void
GLTracer_glTexImage3D(GLenum target,
                      GLint level,
                      GLint internalformat,
                      GLsizei width,
                      GLsizei height,
...
void
GLTracer_glActiveTexture(GLenum texture)
{
...
void
GLTracer_glCompressedTexImage3D(GLenum target,
                                GLint level,
                                ...
                                const void *data)
{
    printf("glCompressedTexImage3D("
           ...
           imageSize,
           data);
    apiHook.glCompressedTexImage3D(target,
                                   level,
                                   internalformat,
                                   width,
                                   height,
...
void
GLTracer_glCompressedTexImage2D(GLenum target,
                                GLint level,
                                GLenum internalformat,
                                GLsizei width,
                                GLsizei height,
...
void
GLTracer_glGetCompressedTexImage(GLenum target, GLint level, void *img)
{
...
void
GLTracer_glGenQueries(GLsizei n, GLuint *ids)
{
    printf("glGenQueries("
           "%i, %p)\n",
           n,
...
void
GLTracer_glDeleteQueries(GLsizei n, const GLuint *ids)
{
...
void
GLTracer_glBeginQuery(GLenum target, GLuint id)
{
    printf("glBeginQuery("
           "%s, %u)\n",
           E2S(target),
...
void
GLTracer_glEndQuery(GLenum target)
{
    printf("glEndQuery("
           "%s)\n",
           E2S(target));
...
void
GLTracer_glGetQueryObjectiv(GLuint id, GLenum pname, GLint *params)
{
...
void
GLTracer_glBindBuffer(GLenum target, GLuint buffer)
{
    printf("glBindBuffer("
           "%s, %u)\n",
           E2S(target),
...
void
GLTracer_glDeleteBuffers(GLsizei n, const GLuint *buffers)
{
...
void
GLTracer_glGenBuffers(GLsizei n, GLuint *buffers)
{
    printf("glGenBuffers("
           "%i, %p)\n",
           n,
...
void
GLTracer_glBufferData(GLenum target,
                      GLsizeiptr size,
                      const void *data,
                      GLenum usage)
{
...
void
GLTracer_glBufferSubData(GLenum target,
                         GLintptr offset,
                         GLsizeiptr size,
                         const void *data)
{
...
void
GLTracer_glDrawBuffers(GLsizei n, const GLenum *bufs)
{
...
void
GLTracer_glAttachShader(GLuint program, GLuint shader)
{
...
void
GLTracer_glBindAttribLocation(GLuint program, GLuint index, const GLchar *name)
{
...
void
GLTracer_glCompileShader(GLuint shader)
{
...
GLuint
GLTracer_glCreateShader(GLenum type)
{
...
void
GLTracer_glDeleteProgram(GLuint program)
{
...
void
GLTracer_glDeleteShader(GLuint shader)
{
...
void
GLTracer_glDisableVertexAttribArray(GLuint index)
{
...
void
GLTracer_glEnableVertexAttribArray(GLuint index)
{
...
void
GLTracer_glGetActiveAttrib(GLuint program,
                           GLuint index,
                           GLsizei bufSize,
                           GLsizei *length,
                           GLint *size,
...
void
GLTracer_glGetActiveUniform(GLuint program,
                            GLuint index,
                            GLsizei bufSize,
                            GLsizei *length,
                            GLint *size,
...
GLint
GLTracer_glGetAttribLocation(GLuint program, const GLchar *name)
{
...
void
GLTracer_glGetProgramiv(GLuint program, GLenum pname, GLint *params)
{
...
void
GLTracer_glGetProgramInfoLog(GLuint program,
                             GLsizei bufSize,
                             GLsizei *length,
                             GLchar *infoLog)
{
...
void
GLTracer_glGetShaderiv(GLuint shader, GLenum pname, GLint *params)
{
...
void
GLTracer_glGetShaderInfoLog(GLuint shader,
                            GLsizei bufSize,
                            GLsizei *length,
                            GLchar *infoLog)
{
...
GLint
GLTracer_glGetUniformLocation(GLuint program, const GLchar *name)
{
...
GLboolean
GLTracer_glIsProgram(GLuint program)
{
    printf("glIsProgram("
           "%u)\n",
           program);
...
GLboolean
GLTracer_glIsShader(GLuint shader)
{
    printf("glIsShader("
           "%u)\n",
           shader);
...
void
GLTracer_glLinkProgram(GLuint program)
{
...
void
GLTracer_glShaderSource(GLuint shader,
                        GLsizei count,
...
void
GLTracer_glUseProgram(GLuint program)
{
    printf("glUseProgram("
           "%u)\n",
           program);
...
void
GLTracer_glUniform1f(GLint location, GLfloat v0)
{
    printf("glUniform1f("
           "%i, %f)\n",
           location,
...
void
GLTracer_glUniform1i(GLint location, GLint v0)
{
    printf("glUniform1i("
           "%i, %i)\n",
           location,
...
void
GLTracer_glUniform1fv(GLint location, GLsizei count, const GLfloat *value)
{
    printf("glUniform1fv("
           "%i, %i, %p)\n",
           location,
...
void
GLTracer_glUniform3fv(GLint location, GLsizei count, const GLfloat *value)
{
    printf("glUniform3fv("
           "%i, %i, %p)\n",
           location,
...
void
GLTracer_glUniform4fv(GLint location, GLsizei count, const GLfloat *value)
{
    printf("glUniform4fv("
           "%i, %i, %p)\n",
           location,
...
void
GLTracer_glUniform1iv(GLint location, GLsizei count, const GLint *value)
{
    printf("glUniform1iv("
           "%i, %i, %p)\n",
           location,
...
void
GLTracer_glUniformMatrix3fv(GLint location,
                            GLsizei count,
                            GLboolean transpose,
                            const GLfloat *value)
{
...
void
GLTracer_glUniformMatrix4fv(GLint location,
                            GLsizei count,
                            GLboolean transpose,
                            const GLfloat *value)
{
...
void
GLTracer_glValidateProgram(GLuint program)
{
...
void
GLTracer_glVertexAttribPointer(GLuint index,
                               GLint size,
                               GLenum type,
...
void
GLTracer_glEnablei(GLenum target, GLuint index)
{
    printf("glEnablei("
           "%s, %u)\n",
           E2S(target),
...
void
GLTracer_glDisablei(GLenum target, GLuint index)
{
    printf("glDisablei("
           "%s, %u)\n",
           E2S(target),
...
void
GLTracer_glBindBufferRange(GLenum target,
                           GLuint index,
                           GLuint buffer,
                           GLintptr offset,
                           GLsizeiptr size)
...
void
GLTracer_glBindBufferBase(GLenum target, GLuint index, GLuint buffer)
{
...
void
GLTracer_glBindFragDataLocation(GLuint program,
                                GLuint color,
                                const GLchar *name)
{
...
const GLubyte *
GLTracer_glGetStringi(GLenum name, GLuint index)
{
    printf("glGetStringi("
           "%s, %u)\n",
           E2S(name),
...
void
GLTracer_glBindFramebuffer(GLenum target, GLuint framebuffer)
{
...
void
GLTracer_glDeleteFramebuffers(GLsizei n, const GLuint *framebuffers)
{
...
void
GLTracer_glGenFramebuffers(GLsizei n, GLuint *framebuffers)
{
...
GLenum
GLTracer_glCheckFramebufferStatus(GLenum target)
{
...
void
GLTracer_glFramebufferTexture2D(GLenum target,
                                GLenum attachment,
                                GLenum textarget,
                                GLuint texture,
                                GLint level)
...
void
GLTracer_glFramebufferTexture3D(GLenum target,
                                GLenum attachment,
                                GLenum textarget,
                                GLuint texture,
                                GLint level,
...
void
GLTracer_glGenerateMipmap(GLenum target)
{
...
void
GLTracer_glBindVertexArray(GLuint array)
{
...
void
GLTracer_glDeleteVertexArrays(GLsizei n, const GLuint *arrays)
{
...
void
GLTracer_glGenVertexArrays(GLsizei n, GLuint *arrays)
{
...
void
GLTracer_glDrawArraysInstanced(GLenum mode,
                               GLint first,
                               GLsizei count,
...
void
GLTracer_glDrawElementsInstanced(GLenum mode,
                                 GLsizei count,
                                 GLenum type,
                                 const void *indices,
                                 GLsizei instancecount)
...
void
GLTracer_glGetActiveUniformBlockiv(GLuint program,
...
void
GLTracer_glUniformBlockBinding(GLuint program,
                               GLuint uniformBlockIndex,
...
void
GLTracer_glGetQueryObjectui64v(GLuint id, GLenum pname, GLuint64 *params)
{
...
GLint
GLTracer_glGetSubroutineUniformLocation(GLuint program,
                                        GLenum shadertype,
                                        const GLchar *name)
{
...
GLuint
GLTracer_glGetSubroutineIndex(GLuint program,
                              GLenum shadertype,
                              const GLchar *name)
{
...
void
GLTracer_glGetActiveSubroutineUniformiv(GLuint program,
                                        GLenum shadertype,
                                        GLuint index,
                                        GLenum pname,
                                        GLint *values)
...
void
GLTracer_glGetActiveSubroutineName(GLuint program,
                                   GLenum shadertype,
                                   GLuint index,
                                   GLsizei bufsize,
                                   GLsizei *length,
...
void
GLTracer_glUniformSubroutinesuiv(GLenum shadertype,
                                 GLsizei count,
...
void
GLTracer_glGetProgramStageiv(GLuint program,
                             GLenum shadertype,
                             GLenum pname,
                             GLint *values)
{
...
void
GLTracer_glPatchParameteri(GLenum pname, GLint value)
{
...
void
GLTracer_glGetProgramBinary(GLuint program,
                            GLsizei bufSize,
                            GLsizei *length,
                            GLenum *binaryFormat,
                            void *binary)
...
void
GLTracer_glProgramBinary(GLuint program,
                         GLenum binaryFormat,
                         const void *binary,
                         GLsizei length)
{
...
void
GLTracer_glProgramParameteri(GLuint program, GLenum pname, GLint value)
{
...
void
GLTracer_glProgramUniform1i(GLuint program, GLint location, GLint v0)
{
...
void
GLTracer_glProgramUniform1f(GLuint program, GLint location, GLfloat v0)
{
...
void
GLTracer_glProgramUniform2iv(GLuint program,
                             GLint location,
                             GLsizei count,
                             const GLint *value)
{
...
void
GLTracer_glProgramUniform2fv(GLuint program,
                             GLint location,
                             GLsizei count,
                             const GLfloat *value)
{
...
void
GLTracer_glProgramUniform3iv(GLuint program,
                             GLint location,
                             GLsizei count,
                             const GLint *value)
{
...
void
GLTracer_glProgramUniform3fv(GLuint program,
                             GLint location,
                             GLsizei count,
                             const GLfloat *value)
{
...
void
GLTracer_glProgramUniform4iv(GLuint program,
                             GLint location,
                             GLsizei count,
                             const GLint *value)
{
...
void
GLTracer_glProgramUniform4fv(GLuint program,
                             GLint location,
                             GLsizei count,
                             const GLfloat *value)
{
...
void
GLTracer_glBindTextures(GLuint first, GLsizei count, const GLuint *textures)
{
...
void
GLTracer_glCreateTransformFeedbacks(GLsizei n, GLuint *ids)
{
...
void
GLTracer_glTransformFeedbackBufferBase(GLuint xfb, GLuint index, GLuint buffer)
{
...
void
GLTracer_glTransformFeedbackBufferRange(GLuint xfb,
                                        GLuint index,
                                        GLuint buffer,
                                        GLintptr offset,
                                        GLsizei size)
...
void
GLTracer_glGetTransformFeedbackiv(GLuint xfb, GLenum pname, GLint *param)
{
...
void
GLTracer_glGetTransformFeedbacki_v(GLuint xfb,
                                   GLenum pname,
                                   GLuint index,
                                   GLint *param)
{
...
void
GLTracer_glGetTransformFeedbacki64_v(GLuint xfb,
                                     GLenum pname,
                                     GLuint index,
                                     GLint64 *param)
{
...
void
GLTracer_glCreateBuffers(GLsizei n, GLuint *buffers)
{
...
void
GLTracer_glNamedBufferStorage(GLuint buffer,
                              GLsizei size,
                              const void *data,
                              GLbitfield flags)
{
...
void
GLTracer_glNamedBufferData(GLuint buffer,
                           GLsizei size,
                           const void *data,
                           GLenum usage)
{
...
void
GLTracer_glNamedBufferSubData(GLuint buffer,
                              GLintptr offset,
                              GLsizei size,
                              const void *data)
{
...
void
GLTracer_glCopyNamedBufferSubData(GLuint readBuffer,
                                  GLuint writeBuffer,
                                  GLintptr readOffset,
...
void
GLTracer_glClearNamedBufferData(GLuint buffer,
                                GLenum internalformat,
                                GLenum format,
                                GLenum type,
                                const void *data)
...
void
GLTracer_glClearNamedBufferSubData(GLuint buffer,
                                   GLenum internalformat,
                                   GLintptr offset,
                                   GLsizei size,
                                   GLenum format,
...
void *
GLTracer_glMapNamedBuffer(GLuint buffer, GLenum access)
{
...
void *
GLTracer_glMapNamedBufferRange(GLuint buffer,
                               GLintptr offset,
                               GLsizei length,
                               GLbitfield access)
{
...
GLboolean
GLTracer_glUnmapNamedBuffer(GLuint buffer)
{
...
void
GLTracer_glFlushMappedNamedBufferRange(GLuint buffer,
                                       GLintptr offset,
                                       GLsizei length)
{
...
void
GLTracer_glGetNamedBufferParameteriv(GLuint buffer, GLenum pname, GLint *params)
{
...
void
GLTracer_glGetNamedBufferParameteri64v(GLuint buffer,
                                       GLenum pname,
                                       GLint64 *params)
{
...
void
GLTracer_glGetNamedBufferPointerv(GLuint buffer, GLenum pname, void **params)
{
...
void
GLTracer_glGetNamedBufferSubData(GLuint buffer,
                                 GLintptr offset,
                                 GLsizei size,
                                 void *data)
{
...
void
GLTracer_glCreateFramebuffers(GLsizei n, GLuint *framebuffers)
{
...
void
GLTracer_glNamedFramebufferRenderbuffer(GLuint framebuffer,
                                        GLenum attachment,
...
void
GLTracer_glNamedFramebufferParameteri(GLuint framebuffer,
                                      GLenum pname,
                                      GLint param)
{
...
void
GLTracer_glNamedFramebufferTexture(GLuint framebuffer,
                                   GLenum attachment,
                                   GLuint texture,
                                   GLint level)
{
...
void
GLTracer_glNamedFramebufferTextureLayer(GLuint framebuffer,
                                        GLenum attachment,
                                        GLuint texture,
                                        GLint level,
                                        GLint layer)
...
void
GLTracer_glNamedFramebufferDrawBuffer(GLuint framebuffer, GLenum buf)
{
...
void
GLTracer_glNamedFramebufferDrawBuffers(GLuint framebuffer,
                                       GLsizei n,
                                       const GLenum *bufs)
{
...
void
GLTracer_glNamedFramebufferReadBuffer(GLuint framebuffer, GLenum src)
{
...
void
GLTracer_glInvalidateNamedFramebufferData(GLuint framebuffer,
...
void
GLTracer_glInvalidateNamedFramebufferSubData(GLuint framebuffer,
                                             GLsizei numAttachments,
                                             const GLenum *attachments,
                                             GLint x,
                                             GLint y,
...
void
GLTracer_glClearNamedFramebufferiv(GLuint framebuffer,
                                   GLenum buffer,
                                   GLint drawbuffer,
                                   const GLint *value)
{
...
void
GLTracer_glClearNamedFramebufferuiv(GLuint framebuffer,
                                    GLenum buffer,
                                    GLint drawbuffer,
                                    const GLuint *value)
{
...
void
GLTracer_glClearNamedFramebufferfv(GLuint framebuffer,
                                   GLenum buffer,
                                   GLint drawbuffer,
                                   const GLfloat *value)
{
...
void
GLTracer_glClearNamedFramebufferfi(GLuint framebuffer,
                                   GLenum buffer,
                                   const GLfloat depth,
                                   GLint stencil)
{
...
void
GLTracer_glBlitNamedFramebuffer(GLuint readFramebuffer,
                                ...
                                GLenum filter)
{
    printf("glBlitNamedFramebuffer("
           ...
           (unsigned int)(mask),
           E2S(filter));
    apiHook.glBlitNamedFramebuffer(readFramebuffer,
                                   drawFramebuffer,
                                   srcX0,
                                   srcY0,
                                   srcX1,
...
GLenum
GLTracer_glCheckNamedFramebufferStatus(GLuint framebuffer, GLenum target)
{
...
void
GLTracer_glGetNamedFramebufferParameteriv(GLuint framebuffer,
                                          GLenum pname,
                                          GLint *param)
{
...
void
GLTracer_glGetNamedFramebufferAttachmentParameteriv(GLuint framebuffer,
                                                    GLenum attachment,
                                                    GLenum pname,
                                                    GLint *params)
{
...
void
GLTracer_glCreateRenderbuffers(GLsizei n, GLuint *renderbuffers)
{
...
void
GLTracer_glNamedRenderbufferStorage(GLuint renderbuffer,
                                    GLenum internalformat,
                                    GLsizei width,
                                    GLsizei height)
{
...
void
GLTracer_glNamedRenderbufferStorageMultisample(GLuint renderbuffer,
                                               GLsizei samples,
                                               GLenum internalformat,
                                               GLsizei width,
                                               GLsizei height)
...
void
GLTracer_glGetNamedRenderbufferParameteriv(GLuint renderbuffer,
                                           GLenum pname,
                                           GLint *params)
{
...
void
GLTracer_glCreateTextures(GLenum target, GLsizei n, GLuint *textures)
{
...
void
GLTracer_glTextureBuffer(GLuint texture, GLenum internalformat, GLuint buffer)
{
...
void
GLTracer_glTextureBufferRange(GLuint texture,
                              GLenum internalformat,
                              GLuint buffer,
                              GLintptr offset,
                              GLsizei size)
...
void
GLTracer_glTextureStorage1D(GLuint texture,
                            GLsizei levels,
                            GLenum internalformat,
                            GLsizei width)
{
...
void
GLTracer_glTextureStorage2D(GLuint texture,
                            GLsizei levels,
                            GLenum internalformat,
                            GLsizei width,
                            GLsizei height)
...
void
GLTracer_glTextureStorage3D(GLuint texture,
                            GLsizei levels,
                            GLenum internalformat,
                            GLsizei width,
                            GLsizei height,
...
void
GLTracer_glTextureStorage2DMultisample(GLuint texture,
                                       GLsizei samples,
                                       GLenum internalformat,
                                       GLsizei width,
                                       GLsizei height,
...
void
GLTracer_glTextureStorage3DMultisample(GLuint texture,
                                       GLsizei samples,
                                       GLenum internalformat,
                                       GLsizei width,
                                       GLsizei height,
                                       ...
                                       GLboolean fixedsamplelocations)
{
    printf("glTextureStorage3DMultisample("
           ...
           depth,
           (unsigned int)(fixedsamplelocations));
    apiHook.glTextureStorage3DMultisample(texture,
                                          samples,
                                          internalformat,
                                          width,
                                          height,
...
void
GLTracer_glTextureSubImage1D(GLuint texture,
                             GLint level,
                             GLint xoffset,
                             GLsizei width,
                             GLenum format,
...
void
GLTracer_glTextureSubImage2D(GLuint texture,
                             GLint level,
                             GLint xoffset,
                             GLint yoffset,
                             GLsizei width,
...
void
GLTracer_glTextureSubImage3D(GLuint texture,
                             GLint level,
                             GLint xoffset,
                             GLint yoffset,
                             GLint zoffset,
                             ...
                             const void *pixels)
{
    printf("glTextureSubImage3D("
           ...
           E2S(type),
           pixels);
    apiHook.glTextureSubImage3D(texture,
                                level,
                                xoffset,
                                yoffset,
                                zoffset,
...
void
GLTracer_glCompressedTextureSubImage1D(GLuint texture,
                                       GLint level,
                                       GLint xoffset,
                                       GLsizei width,
                                       GLenum format,
...
void
GLTracer_glCompressedTextureSubImage2D(GLuint texture,
                                       GLint level,
                                       GLint xoffset,
                                       GLint yoffset,
                                       GLsizei width,
...
void
GLTracer_glCompressedTextureSubImage3D(GLuint texture,
                                       GLint level,
                                       GLint xoffset,
                                       GLint yoffset,
                                       GLint zoffset,
                                       ...
                                       const void *data)
{
    printf("glCompressedTextureSubImage3D("
           ...
           imageSize,
           data);
    apiHook.glCompressedTextureSubImage3D(texture,
                                          level,
                                          xoffset,
                                          yoffset,
                                          zoffset,
...
void
GLTracer_glCopyTextureSubImage1D(GLuint texture,
                                 GLint level,
                                 GLint xoffset,
                                 GLint x,
                                 GLint y,
...
void
GLTracer_glCopyTextureSubImage2D(GLuint texture,
                                 GLint level,
                                 GLint xoffset,
                                 GLint yoffset,
                                 GLint x,
...
void
GLTracer_glCopyTextureSubImage3D(GLuint texture,
                                 GLint level,
                                 GLint xoffset,
                                 GLint yoffset,
                                 GLint zoffset,
...
void
GLTracer_glTextureParameterf(GLuint texture, GLenum pname, GLfloat param)
{
...
void
GLTracer_glTextureParameterfv(GLuint texture,
                              GLenum pname,
                              const GLfloat *param)
{
...
void
GLTracer_glTextureParameteri(GLuint texture, GLenum pname, GLint param)
{
...
void
GLTracer_glTextureParameterIiv(GLuint texture,
                               GLenum pname,
                               const GLint *params)
{
...
void
GLTracer_glTextureParameterIuiv(GLuint texture,
                                GLenum pname,
                                const GLuint *params)
{
...
void
GLTracer_glTextureParameteriv(GLuint texture, GLenum pname, const GLint *param)
{
...
void
GLTracer_glGenerateTextureMipmap(GLuint texture)
{
...
void
GLTracer_glBindTextureUnit(GLuint unit, GLuint texture)
{
...
void
GLTracer_glGetTextureImage(GLuint texture,
                           GLint level,
                           GLenum format,
                           GLenum type,
                           GLsizei bufSize,
...
void
GLTracer_glGetCompressedTextureImage(GLuint texture,
                                     GLint level,
                                     GLsizei bufSize,
                                     void *pixels)
{
...
void
GLTracer_glGetTextureLevelParameterfv(GLuint texture,
                                      GLint level,
                                      GLenum pname,
                                      GLfloat *params)
{
...
void
GLTracer_glGetTextureLevelParameteriv(GLuint texture,
                                      GLint level,
                                      GLenum pname,
                                      GLint *params)
{
...
void
GLTracer_glGetTextureParameterfv(GLuint texture, GLenum pname, GLfloat *params)
{
...
void
GLTracer_glGetTextureParameterIiv(GLuint texture, GLenum pname, GLint *params)
{
...
void
GLTracer_glGetTextureParameterIuiv(GLuint texture, GLenum pname, GLuint *params)
{
...
void
GLTracer_glGetTextureParameteriv(GLuint texture, GLenum pname, GLint *params)
{
...
void
GLTracer_glCreateVertexArrays(GLsizei n, GLuint *arrays)
{
...
void
GLTracer_glDisableVertexArrayAttrib(GLuint vaobj, GLuint index)
{
...
void
GLTracer_glEnableVertexArrayAttrib(GLuint vaobj, GLuint index)
{
...
void
GLTracer_glVertexArrayElementBuffer(GLuint vaobj, GLuint buffer)
{
...
void
GLTracer_glVertexArrayVertexBuffer(GLuint vaobj,
                                   GLuint bindingindex,
                                   GLuint buffer,
                                   GLintptr offset,
                                   GLsizei stride)
...
void
GLTracer_glVertexArrayVertexBuffers(GLuint vaobj,
                                    GLuint first,
                                    GLsizei count,
...
void
GLTracer_glVertexArrayAttribBinding(GLuint vaobj,
                                    GLuint attribindex,
                                    GLuint bindingindex)
{
...
void
GLTracer_glVertexArrayAttribFormat(GLuint vaobj,
                                   GLuint attribindex,
                                   GLint size,
                                   GLenum type,
                                   GLboolean normalized,
...
void
GLTracer_glVertexArrayAttribIFormat(GLuint vaobj,
                                    GLuint attribindex,
                                    GLint size,
                                    GLenum type,
                                    GLuint relativeoffset)
...
void
GLTracer_glVertexArrayAttribLFormat(GLuint vaobj,
                                    GLuint attribindex,
                                    GLint size,
                                    GLenum type,
                                    GLuint relativeoffset)
...
void
GLTracer_glVertexArrayBindingDivisor(GLuint vaobj,
                                     GLuint bindingindex,
                                     GLuint divisor)
{
...
void
GLTracer_glGetVertexArrayiv(GLuint vaobj, GLenum pname, GLint *param)
{
...
void
GLTracer_glGetVertexArrayIndexediv(GLuint vaobj,
                                   GLuint index,
                                   GLenum pname,
                                   GLint *param)
{
...
void
GLTracer_glGetVertexArrayIndexed64iv(GLuint vaobj,
                                     GLuint index,
                                     GLenum pname,
                                     GLint64 *param)
{
...
void
GLTracer_glCreateSamplers(GLsizei n, GLuint *samplers)
{
...
void
GLTracer_glCreateProgramPipelines(GLsizei n, GLuint *pipelines)
{
...
void
GLTracer_glCreateQueries(GLenum target, GLsizei n, GLuint *ids)
{
...
void
GetAPI4(GL4API *api, PFNGETGLPROC GetGLProc)
{
