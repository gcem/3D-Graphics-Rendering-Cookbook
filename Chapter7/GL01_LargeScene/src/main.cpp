...
public:
    explicit GLMesh(const GLSceneData &data)
      ...
      , bufferIndices_(data.header_.indexDataSize,
                       data.meshData_.indexData_.data(),
                       0)
      , bufferVertices_(data.header_.vertexDataSize,
                        data.meshData_.vertexData_.data(),
                        0)
      , bufferMaterials_(sizeof(MaterialDescription) * data.materials_.size(),
                             ...
                             GL_DYNAMIC_STORAGE_BIT)
    {
        ...
        glVertexArrayVertexBuffer(vao_,
                                  0,
                                  bufferVertices_.getHandle(),
                                  0,
        ...
        glNamedBufferSubData(bufferModelMatrices_.getHandle(),
                             0,
    ...
    void draw(const GLSceneData &data) const
    {
        ...
        glBindBufferBase(GL_SHADER_STORAGE_BUFFER,
                         kBufferIndex_Materials,
                         bufferMaterials_.getHandle());
        glBindBufferBase(GL_SHADER_STORAGE_BUFFER,
                         kBufferIndex_ModelMatrices,
        ...
        glMultiDrawElementsIndirectCount(GL_TRIANGLES,
                                         GL_UNSIGNED_INT,
                                         (const void *)sizeof(GLsizei),
                                         0,
                                         (GLsizei)data.shapes_.size(),
                                         0);
    }
